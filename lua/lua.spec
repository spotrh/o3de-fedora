...
# extra headers, because some things want the internal bits of lua
install -m 644 src/lobject.h src/ldo.h src/lfunc.h src/lgc.h src/llimits.h src/lmem.h src/lopcodes.h src/lstring.h src/lstate.h src/ltm.h src/lzio.h src/lundump.h %{buildroot}%{_includedir}/
...
- update to 5.4.3
- package up some internal headers
