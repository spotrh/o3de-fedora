...
Source:        https://gitlab.com/libtiff/libtiff/-/archive/master/libtiff-master.tar.bz2
...
%changelog
* Sun Apr 11 2021 Tom Callaway <spot@fedoraproject.org> - 4.2.0-2.gitaab7d6f
- update to git master to resolve uint64 conflicts
