...
#extra headers
cp -a src/ldo.h src/lfunc.h src/lgc.h src/llimits.h src/lmem.h src/lobject.h src/lopcodes.h src/lstate.h src/lstring.h src/ltm.h src/lundump.h src/lzio.h %{buildroot}%{_includedir}/lua-5.1/
...
%changelog
* Wed Apr 28 2021 Tom Callaway <spot@fedoraproject.org> - 5.1.5-19
- extra headers for o3de
